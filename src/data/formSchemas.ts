...
export const FORM_SCHEMAS: FormSchema[] = [
  // ── Section 01: Sales & Customer Service ──────────────────────────────
  {
    ...
    frequency: "On event",
    importance: "Critical",
    description: "Project initiation record — captures client, scope, dates, and deliverables.",
    fields: [
      ...
      { key: "project_name", label: "Project Name", type: "text", required: true, width: "full" },
      { key: "client_name", label: "Client Name", type: "text", required: true, width: "half" },
      { key: "client_contact", label: "Client Contact", type: "text", width: "half" },
      { key: "start_date", label: "Start Date", type: "date", required: true, width: "half" },
      { key: "end_date", label: "End Date", type: "date", required: true, width: "half" },
      { key: "scope", label: "Scope of Work", type: "textarea", required: true, width: "full" },
      { key: "deliverables", label: "Deliverables", type: "textarea", width: "full" },
      { key: "approved_by", label: "Approved By", type: "signature", required: true, width: "half" },
      { key: "approval_date", label: "Approval Date", type: "date", required: true, width: "half" },
    ],
  },
  {
    code: "F/09",
