...
export const FORM_SCHEMAS: FormSchema[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "rating_product_quality", label: "Product Quality", type: "select", options: ["Excellent", "Good", "Satisfactory", "Average", "Poor"], width: "full" },
      { key: "rating_order_processing", label: "Order Processing", type: "select", options: ["Excellent", "Good", "Satisfactory", "Average", "Poor"], width: "full" },
      { key: "rating_complaint_handling", label: "Complaint Handling", type: "select", options: ["Excellent", "Good", "Satisfactory", "Average", "Poor"], width: "full" },
      { key: "rating_delivery", label: "Delivery", type: "select", options: ["Excellent", "Good", "Satisfactory", "Average", "Poor"], width: "full" },
      { key: "rating_price", label: "Price", type: "select", options: ["Excellent", "Good", "Satisfactory", "Average", "Poor"], width: "full" },
