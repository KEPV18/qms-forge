...
import { type LucideIcon, Loader2, AlertTriangle, Inbox, CheckCircle } from "lucide-react";
...
export function StateScreen({ state = "empty", icon: CustomIcon, title, message, action, className }: StateScreenProps) {
